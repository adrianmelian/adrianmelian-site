...
{{< gallery >}}
  ...
  {{< figure src="/gallery/020.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/021.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/024.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/016.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/014.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/015.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/034.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/013.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/041.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/032.jpg" caption="Life Drawing with charcoal & pencil on paper." class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/033.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/031.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/030.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/029.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
  {{< figure src="/gallery/028.jpg" class="grid-w50 md:grid-w33 xl:grid-w25" >}}
